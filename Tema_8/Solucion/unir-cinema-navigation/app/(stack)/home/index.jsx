...
const HomeScreen = () => {
    return (
        <View className="flex-1 px-10 mt-5 bg-white-500 text-white">
            ...
            <CinemaButton onPress={() => router.push('/(stack)/landing/Madrid')}
                          onLongPress={() => console.log("Cine de Madrid - LongPress")}>
                Madrid
            </CinemaButton>
            <CinemaButton onPress={() => router.push('/(stack)/landing/Barcelona')}
                          onLongPress={() => console.log("Cine de Barcelona - LongPress")}>
                Barcelona
            </CinemaButton>
            <CinemaButton onPress={() => router.push('/(stack)/landing/Valencia')}
                          onLongPress={() => console.log("Cine de Valencia - LongPress")}>
                Valencia
            </CinemaButton>
            <CinemaButton onPress={() => router.push('/(stack)/landing/Sevilla')}
                          onLongPress={() => console.log("Cine de Sevilla - LongPress")}>
                Sevilla
            </CinemaButton>


            <View className="flex-1 bg-unirLogoBg self-center absolute bottom-0 mb-5">
                <Image
