    ...
    return (
        <View className="flex-1 mt-5">
            <View className="flex-1 px-10 mt-5 bg-white-500 text-white">
                ...
                <CinemaButton onPress={() => router.push('/landing/Madrid')}
                              onLongPress={() => console.log("Cine de Madrid - LongPress")}>
                    Madrid
                </CinemaButton>
                <CinemaButton onPress={() => router.push('/landing/Barcelona')}
                              onLongPress={() => console.log("Cine de Barcelona - LongPress")}>
                    Barcelona
                </CinemaButton>
                <CinemaButton onPress={() => router.push('/landing/Valencia')}
                              onLongPress={() => console.log("Cine de Valencia - LongPress")}>
                    Valencia
                </CinemaButton>
                <CinemaButton onPress={() => router.push('/landing/Sevilla')}
